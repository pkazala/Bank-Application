...
public class UnitTest {
    ...
    public void createAccount(){
        Account account = new Account("7fd45a98-96eb-4777-8525-6696ded416bd", "Alexa Ferry", 43806.89f, "PKR", "Money Market Account");
    ...
    public void addingFunds() {
        Account account = new Account("7fd45a98-96eb-4777-8525-6696ded416bd", "Alexa Ferry", 0f, "PKR", "Money Market Account");
        account.deposit(50);
        account.deposit(20);
    ...
    public void noOverdraft() {
        Account account = new Account("7fd45a98-96eb-4777-8525-6696ded416bd", "Alexa Ferry", 30f, "PKR", "Money Market Account");
    ...
    public void superSaving() {
        Account account = new Account("7fd45a98-96eb-4777-8525-6696ded416bd", "Alexa Ferry", 20f, "PKR", "Money Market Account");
        for(int i =0; i<5;i++){
            account.deposit(10);
        }
        for(int i =0; i<3;i++){
    ...
    public void takeCareOfPennies() {
        Account account = new Account("7fd45a98-96eb-4777-8525-6696ded416bd", "Alexa Ferry", 5.45f, "PKR", "Money Market Account");
